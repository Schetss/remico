...
namespace Frontend\Modules\SmallBlocks\Engine;
...
class Model
{
    ...
    public static function get($URL)
    {
        ...
        // create full url
        $item['full_url'] = Navigation::getURLForBlock('SmallBlocks', 'Detail') . '/' . $item['url'];
    ...
    public static function getAll($limit = 10, $offset = 0)
    {
        ...
        $detailUrl = Navigation::getURLForBlock('SmallBlocks', 'Detail');
    ...
    public static function getAllCategories()
    {
        $return = (array) FrontendModel::get('database')->getRecords(
            'SELECT c.id, c.title AS label, m.url, COUNT(c.id) AS total, m.data AS meta_data
             ...
             INNER JOIN small_blocks AS i ON c.id = i.category_id AND c.language = i.language
    ...
    public static function getCategory($URL)
    {
        ...
        // create full url
        $item['full_url'] = Navigation::getURLForBlock('SmallBlocks', 'category') . '/' . $item['url'];
