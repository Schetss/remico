...
namespace Frontend\Modules\SmallBlocks\Actions;
...
/**
 * This is the category-action, it will display the overview of Small blocks categories
 *
...
class Category extends Block
{
    ...
    private function getData()
    {
        ...
        // get category
        $this->category = FrontendSmallBlocksModel::getCategory($this->URL->getParameter(0));
        ...
        // set URL and limit
        $this->pagination['url'] = Navigation::getURLForBlock('SmallBlocks', 'category') . '/' . $this->category['url'];

        $this->pagination['limit'] = $this->get('fork.settings')->get('SmallBlocks', 'overview_num_items', 10);

        // populate count fields in pagination
        $this->pagination['num_items'] = FrontendSmallBlocksModel::getCategoryCount($this->category['id']);
        ...
        // get items
        $this->items = FrontendSmallBlocksModel::getAllByCategory(
