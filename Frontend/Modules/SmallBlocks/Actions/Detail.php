...
class Detail extends Block
{
    ...
    private function getData()
    {
        ...
        $this->record = FrontendSmallBlocksModel::get($lastParameter);
    ...
    protected function parse()
    {
         ...
         * $this->header->addOpenGraphImage(FRONTEND_FILES_URL . '/small_blocks/images/source/' . $this->record['image']);
         */
        ...
        $this->header->addOpenGraphData(
            'url',
            SITE_URL . Navigation::getURLForBlock('SmallBlocks', 'Detail') . '/' . $this->record['url'],
            true
        );
        $this->header->addOpenGraphData(
            'site_name',
