...
namespace Frontend\Modules\Spotlight\Actions;
...
/**
 * This is the category-action, it will display the overview of Spotlight categories
 *
...
class Category extends Block
{
    ...
    private function getData()
    {
        ...
        // get category
        $this->category = FrontendSpotlightModel::getCategory($this->URL->getParameter(0));
        ...
        // set URL and limit
        $this->pagination['url'] = Navigation::getURLForBlock('Spotlight', 'category') . '/' . $this->category['url'];

        $this->pagination['limit'] = $this->get('fork.settings')->get('Spotlight', 'overview_num_items', 10);

        // populate count fields in pagination
        $this->pagination['num_items'] = FrontendSpotlightModel::getCategoryCount($this->category['id']);
        ...
        // get items
        $this->items = FrontendSpotlightModel::getAllByCategory(
