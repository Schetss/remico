...
namespace Frontend\Modules\Mailchimp\Engine;
...
class Model
{
    ...
    public static function get($URL)
    {
        ...
        // create full url
        $item['full_url'] = Navigation::getURLForBlock('Mailchimp', 'Detail') . '/' . $item['url'];
    ...
    public static function getAll($limit = 10, $offset = 0)
    {
        ...
        $detailUrl = Navigation::getURLForBlock('Mailchimp', 'Detail');
   ...
   public static function getAllCount()
    ...
    public static function getCategory($URL)
    {
        ...
        // create full url
        $item['full_url'] = Navigation::getURLForBlock('Mailchimp', 'category') . '/' . $item['url'];
