...
class Index extends Block
{
    ...
    private function getData()
    {
        ...
        // set URL and limit
        $this->pagination['url'] = Navigation::getURLForBlock('Mailchimp');
        $this->pagination['limit'] = $this->get('fork.settings')->get('Mailchimp', 'overview_num_items', 10);

        // populate count fields in pagination
        $this->pagination['num_items'] = FrontendMailchimpModel::getAllCount();
        ...
        // get articles
        $this->items = FrontendMailchimpModel::getAll(
