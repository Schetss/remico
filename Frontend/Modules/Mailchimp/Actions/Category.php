...
/**
 * This is the category-action, it will display the overview of Mailchimp categories
 *
...
class Category extends Block
{
    ...
    private function getData()
    {
        ...
        // get category
        $this->category = FrontendMailchimpModel::getCategory($this->URL->getParameter(0));
        ...
        // set URL and limit
        $this->pagination['url'] = Navigation::getURLForBlock('Mailchimp', 'category') . '/' . $this->category['url'];

        $this->pagination['limit'] = $this->get('fork.settings')->get('Mailchimp', 'overview_num_items', 10);

        // populate count fields in pagination
        $this->pagination['num_items'] = FrontendMailchimpModel::getCategoryCount($this->category['id']);
        ...
        // get items
        $this->items = FrontendMailchimpModel::getAllByCategory(
