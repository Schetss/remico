...
namespace Frontend\Modules\Makelaars\Actions;
...
class Index extends Block
{
    ...
    private function getData()
    {
        ...
        // set URL and limit
        $this->pagination['url'] = Navigation::getURLForBlock('Makelaars');
        $this->pagination['limit'] = $this->get('fork.settings')->get('Makelaars', 'overview_num_items', 10);

        // populate count fields in pagination
        $this->pagination['num_items'] = FrontendMakelaarsModel::getAllCount();
        ...
        // get articles
        $this->items = FrontendMakelaarsModel::getAll(
