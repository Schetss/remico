...
class Detail extends Block
{
    ...
    private function getData()
    {
        ...
        $this->record = FrontendImageCarouselModel::get($lastParameter);
    ...
    protected function parse()
    {
         ...
         * $this->header->addOpenGraphImage(FRONTEND_FILES_URL . '/image_carousel/images/source/' . $this->record['image']);
         */
        ...
        $this->header->addOpenGraphData(
            'url',
            SITE_URL . Navigation::getURLForBlock('ImageCarousel', 'Detail') . '/' . $this->record['url'],
            true
        );
        $this->header->addOpenGraphData(
            'site_name',
