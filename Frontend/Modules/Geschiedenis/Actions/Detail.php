...
class Detail extends Block
{
    ...
    private function getData()
    {
        ...
        $this->record = FrontendGeschiedenisModel::get($lastParameter);
    ...
    protected function parse()
    {
         ...
         * $this->header->addOpenGraphImage(FRONTEND_FILES_URL . '/geschiedenis/images/source/' . $this->record['image']);
         */
        ...
        $this->header->addOpenGraphData(
            'url',
            SITE_URL . Navigation::getURLForBlock('Geschiedenis', 'Detail') . '/' . $this->record['url'],
            true
        );
        $this->header->addOpenGraphData(
            'site_name',
