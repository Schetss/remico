...
class Detail extends Block
{
    ...
    private function getData()
    {
        ...
        $this->record = FrontendPopulairModel::get($lastParameter);
    ...
    protected function parse()
    {
         ...
         * $this->header->addOpenGraphImage(FRONTEND_FILES_URL . '/populair/images/source/' . $this->record['image']);
         */
        ...
        $this->header->addOpenGraphData(
            'url',
            SITE_URL . Navigation::getURLForBlock('Populair', 'Detail') . '/' . $this->record['url'],
            true
        );
        $this->header->addOpenGraphData(
            'site_name',
