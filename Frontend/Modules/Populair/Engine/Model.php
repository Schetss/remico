...
namespace Frontend\Modules\Populair\Engine;
...
class Model
{
    ...
    public static function get($URL)
    {
        ...
        // create full url
        $item['full_url'] = Navigation::getURLForBlock('Populair', 'Detail') . '/' . $item['url'];
    ...
    public static function getAll($limit = 10, $offset = 0)
    {
        ...
        $detailUrl = Navigation::getURLForBlock('Populair', 'Detail');
     ...
     * @return int
     */
        public static function getAllRegio1()
        {
            $return = (array) FrontendModel::get('database')->getRecords(
               'SELECT id, title AS title, image AS image, goto as url
                FROM populair 
                WHERE sequence = 1;
                ',
                array(),
     ...
     */
         ...
         public static function getAllRegio2()
        {
            $return = (array) FrontendModel::get('database')->getRecords(
               'SELECT id, title AS title, image AS image, goto as url
                FROM populair 
     ...
     */
         ...
         public static function getAllRegio3()
        {
            $return = (array) FrontendModel::get('database')->getRecords(
               'SELECT id, title AS title, image AS image, goto as url
                FROM populair 
