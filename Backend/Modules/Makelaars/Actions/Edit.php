...
class Edit extends ActionEdit
{
    ...
    protected function loadData()
    {
        ...
        if ($this->id == null || !BackendMakelaarsModel::exists($this->id)) {
            $this->redirect(
                Model::createURLForAction('Index') . '&error=non-existing'
            );
        }

        $this->record = BackendMakelaarsModel::get($this->id);
    }
    ...
    protected function loadForm()
    {
        ...
        $this->meta->setUrlCallBack('Backend\Modules\Makelaars\Engine\Model', 'getUrl', array($this->record['id']));
