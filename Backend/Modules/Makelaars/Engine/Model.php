...
namespace Backend\Modules\Makelaars\Engine;
...
class Model
{
    ...
    {
        BackendModel::get('database')->delete('makelaars', 'id = ?', (int) $id);
    }
    ...
    /**
     * Get the maximum Makelaars sequence.
     *
     * @return int
     */
    ...
    public static function insert(array $item)
    {
        ...
        return (int) BackendModel::get('database')->insert('makelaars', $item);
    }
