...
class EditCategory extends ActionEdit
{
    ...
    private function getData()
    {
        ...
        if ($this->id == null || !BackendSmallBlocksModel::existsCategory($this->id)) {
            $this->redirect(
                Model::createURLForAction('categories') . '&error=non-existing'
            );
        }

        $this->record = BackendSmallBlocksModel::getCategory($this->id);
    }
    ...
    private function loadForm()
    {
        ...
        $this->meta->setUrlCallback('Backend\Modules\SmallBlocks\Engine\Model', 'getURLForCategory', array($this->record['id']));
    }
