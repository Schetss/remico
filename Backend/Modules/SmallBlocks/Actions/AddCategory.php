...
class AddCategory extends ActionAdd
{
    ...
    private function loadForm()
    {
        ...
        $this->meta->setURLCallback('Backend\Modules\SmallBlocks\Engine\Model', 'getURLForCategory');
    }
    ...
    private function validateForm()
    {
        if ($this->frm->isSubmitted()) {
            ...
            if ($this->frm->isCorrect()) {
                ...
                $item['sequence'] = BackendSmallBlocksModel::getMaximumCategorySequence() + 1;

                // save the data
                $item['id'] = BackendSmallBlocksModel::insertCategory($item);
