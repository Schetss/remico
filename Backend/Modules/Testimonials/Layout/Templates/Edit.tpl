...
<div class="pageTitle">
    <h2>{$lblTestimonials|ucfirst}: {$lblEdit}</h2>
</div>
                ...
                <tr>
                    <td id="leftColumn">
                        ...
                        <div class="box">
                            <div class="heading">
                                <h3>
                                    <label for="klant">{$lblKlant|ucfirst}</label>
                                </h3>
                            </div>
                            <div class="options">
                                {$txtKlant} {$txtKlantError}
                            </div>
                        </div>
                    ...
                    <td id="sidebar">
                            ...
                            <div class="box">
                                ...
                                <div class="options">
                                    {$chkShow} <label for="show">{$lblShow|ucfirst} </label> {$chkShowError}
                                </div>
                            </div>
