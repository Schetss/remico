...
namespace Backend\Modules\ImageCarousel\Engine;

use Backend\Core\Engine\Model as BackendModel;
use Backend\Core\Engine\Language;

/**
 * In this file we store all generic functions that we will be using in the Image Carousel module
 *
...
class Model
{
    ...
    {
        BackendModel::get('database')->delete('image_carousel', 'id = ?', (int) $id);
    }
    ...
    /**
     * Get the maximum Image Carousel sequence.
     *
     * @return int
     */
    ...
    public static function insert(array $item)
    {
        ...
        return (int) BackendModel::get('database')->insert('image_carousel', $item);
    }
