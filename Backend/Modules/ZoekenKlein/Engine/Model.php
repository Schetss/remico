...
namespace Backend\Modules\ZoekenKlein\Engine;

use Backend\Core\Engine\Model as BackendModel;
use Backend\Core\Engine\Language;

/**
 * In this file we store all generic functions that we will be using in the Zoeken Klein module
 *
...
class Model
{
    ...
    {
        BackendModel::get('database')->delete('zoeken_klein', 'id = ?', (int) $id);
    }
    ...
    public static function insert(array $item)
    {
        ...
        return (int) BackendModel::get('database')->insert('zoeken_klein', $item);
    }
