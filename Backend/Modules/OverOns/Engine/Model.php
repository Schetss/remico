...
namespace Backend\Modules\OverOns\Engine;

use Backend\Core\Engine\Model as BackendModel;
use Backend\Core\Engine\Language;

/**
 * In this file we store all generic functions that we will be using in the Over ons module
 *
...
class Model
{
    ...
    {
        BackendModel::get('database')->delete('over_ons', 'id = ?', (int) $id);
    }
    ...
    /**
     * Get the maximum Over ons sequence.
     *
     * @return int
     */
    ...
    public static function insert(array $item)
    {
        ...
        return (int) BackendModel::get('database')->insert('over_ons', $item);
    }
