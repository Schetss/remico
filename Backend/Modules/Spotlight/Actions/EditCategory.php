...
class EditCategory extends ActionEdit
{
    ...
    private function getData()
    {
        ...
        if ($this->id == null || !BackendSpotlightModel::existsCategory($this->id)) {
            $this->redirect(
                Model::createURLForAction('categories') . '&error=non-existing'
            );
        }

        $this->record = BackendSpotlightModel::getCategory($this->id);
    }
    ...
    private function loadForm()
    {
        ...
        $this->meta->setUrlCallback('Backend\Modules\Spotlight\Engine\Model', 'getURLForCategory', array($this->record['id']));
    }
    ...
    private function validateForm()
    {
        if ($this->frm->isSubmitted()) {
            ...
            if ($this->frm->isCorrect()) {
                ...
                // update the item
                BackendSpotlightModel::updateCategory($item);
