...
class Edit extends ActionEdit
{
    ...
    protected function loadData()
    {
        ...
        if ($this->id == null || !BackendDienstenModel::exists($this->id)) {
            $this->redirect(
                Model::createURLForAction('Index') . '&error=non-existing'
            );
        }

        $this->record = BackendDienstenModel::get($this->id);
    }
    ...
    protected function loadForm()
    {
        ...
        $this->meta->setUrlCallBack('Backend\Modules\Diensten\Engine\Model', 'getUrl', array($this->record['id']));
