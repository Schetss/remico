...
namespace Backend\Modules\Diensten\Engine;

use Backend\Core\Engine\Model as BackendModel;
use Backend\Core\Engine\Language;

/**
 * In this file we store all generic functions that we will be using in the Diensten module
 *
...
class Model
{
    ...
    {
        BackendModel::get('database')->delete('diensten', 'id = ?', (int) $id);
    }
    ...
    /**
     * Get the maximum Diensten sequence.
     *
     * @return int
     */
    ...
    public static function insert(array $item)
    {
        ...
        return (int) BackendModel::get('database')->insert('diensten', $item);
    }
