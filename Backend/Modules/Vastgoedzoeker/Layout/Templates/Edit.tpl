...
<div class="pageTitle">
    <h2>{$lblVastgoedzoeker|ucfirst}: {$lblEdit}</h2>
</div>
                ...
                <tr>
                    <td id="leftColumn">
                        ...
                        <div class="box">
                            <div class="heading">
                                <h3>
                                    <label for="parameter">{$lblParameter|ucfirst}</label>
                                </h3>
                            </div>
                            <div class="options">
                                {$txtParameter} {$txtParameterError}
                            </div>
                        </div>
                    ...
                    <td id="sidebar">
                            ...
                            <div class="box">
                                <div class="heading">
                                    <h3>
                                        <label for="taal">{$lblTaal|ucfirst}<abbr title="{$lblRequiredField}">*</abbr></label>
                                    </h3>
                                </div>
                                <div class="options">
                                    {$ddmTaal} {$ddmTaalError}
                                </div>
                            </div>
