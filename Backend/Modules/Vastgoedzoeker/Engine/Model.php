...
namespace Backend\Modules\Vastgoedzoeker\Engine;
...
class Model
{
    ...
    {
        BackendModel::get('database')->delete('vastgoedzoeker', 'id = ?', (int) $id);
    }
    ...
    /**
     * Get the maximum Vastgoedzoeker sequence.
     *
     * @return int
     */
    ...
    public static function insert(array $item)
    {
        ...
        return (int) BackendModel::get('database')->insert('vastgoedzoeker', $item);
    }
