...
namespace Backend\Modules\Geschiedenis\Engine;
...
class Model
{
    ...
    {
        BackendModel::get('database')->delete('geschiedenis', 'id = ?', (int) $id);
    }
    ...
    public static function insert(array $item)
    {
        ...
        return (int) BackendModel::get('database')->insert('geschiedenis', $item);
    }
