...
namespace Backend\Modules\Populair\Actions;
...
class Edit extends ActionEdit
{
    ...
    protected function loadData()
    {
        ...
        if ($this->id == null || !BackendPopulairModel::exists($this->id)) {
            $this->redirect(
                Model::createURLForAction('Index') . '&error=non-existing'
            );
        }

        $this->record = BackendPopulairModel::get($this->id);
    }
    ...
    protected function loadForm()
    {
        ...
        $this->frm->addCheckbox('hide', $this->record['hide'] == 'Y');

        // meta
        $this->meta = new Meta($this->frm, $this->record['meta_id'], 'title', true);
        $this->meta->setUrlCallBack('Backend\Modules\Populair\Engine\Model', 'getUrl', array($this->record['id']));
    ...
    protected function validateForm()
    {
        if ($this->frm->isSubmitted()) {
            ...
            if ($this->frm->isCorrect()) {
                ...
                $item['hide'] = $fields['hide']->getChecked() ? 'Y' : 'N';
