...
class EditCategory extends ActionEdit
{
    ...
    private function getData()
    {
        ...
        if ($this->id == null || !BackendMailchimpModel::existsCategory($this->id)) {
            $this->redirect(
                Model::createURLForAction('categories') . '&error=non-existing'
            );
        }

        $this->record = BackendMailchimpModel::getCategory($this->id);
    }
    ...
    private function loadForm()
    {
        ...
        $this->meta->setUrlCallback('Backend\Modules\Mailchimp\Engine\Model', 'getURLForCategory', array($this->record['id']));
    }
