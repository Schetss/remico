...
class AddCategory extends ActionAdd
{
    ...
    private function loadForm()
    {
        ...
        $this->meta->setURLCallback('Backend\Modules\Mailchimp\Engine\Model', 'getURLForCategory');
    }
    ...
    private function validateForm()
    {
        if ($this->frm->isSubmitted()) {
            ...
            if ($this->frm->isCorrect()) {
                ...
                $item['sequence'] = BackendMailchimpModel::getMaximumCategorySequence() + 1;

                // save the data
                $item['id'] = BackendMailchimpModel::insertCategory($item);
