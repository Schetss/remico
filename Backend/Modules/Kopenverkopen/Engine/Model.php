...
namespace Backend\Modules\Kopenverkopen\Engine;
...
class Model
{
    ...
    {
        BackendModel::get('database')->delete('kopenverkopen', 'id = ?', (int) $id);
    }
    ...
    /**
     * Get the maximum kopenverkopen sequence.
     *
     * @return int
     */
    ...
    public static function insert(array $item)
    {
        ...
        return (int) BackendModel::get('database')->insert('kopenverkopen', $item);
    }
