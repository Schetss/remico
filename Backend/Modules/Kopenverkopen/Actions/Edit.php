...
class Edit extends ActionEdit
{
    ...
    protected function loadData()
    {
        ...
        if ($this->id == null || !BackendKopenverkopenModel::exists($this->id)) {
            $this->redirect(
                Model::createURLForAction('Index') . '&error=non-existing'
            );
        }

        $this->record = BackendKopenverkopenModel::get($this->id);
    }
    ...
    protected function loadForm()
    {
        ...
        $this->meta->setUrlCallBack('Backend\Modules\Kopenverkopen\Engine\Model', 'getUrl', array($this->record['id']));
    ...
    protected function validateForm()
    {
        if ($this->frm->isSubmitted()) {
            ...
            if ($this->frm->isCorrect()) {
                ...
                BackendKopenverkopenModel::update($item);
                $item['id'] = $this->id;
